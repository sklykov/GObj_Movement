...
double sigma; uint16 picSize; double xC1; double yC1; double xc2;
uint16 iter; char name;
sigma=5; % define size of Gaussian shape object
picSize = 500; % define size of background picture
xC1=4*sigma; yC1=picSize/2; % coordinates of particle center
yC2=4*sigma; xC2=picSize/2; 
...
PO1 = picWithObj(P1,G1,xC1,yC1,0);
BI1=PO1.fuse;
